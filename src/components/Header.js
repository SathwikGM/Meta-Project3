...
const socials = [
  {
    icon: faEnvelope,
    url: "mailto: sathwik140397@gmail.com",
  },
  {
    icon: faGithub,
    url: "https://github.com/SathwikGM",
  },
  {
    icon: faLinkedin,
    url: "https://www.linkedin.com/in/sathwikgm/",
  },
  {
    icon: faMedium,
      ...
      <Box style={{ display: showBox ? 'block' : 'none' }} color="white" maxWidth="1280px" margin="0 auto">
        ...
        >
          <nav>
            ...
            {socials.map(social => {
              return (
                <a key={social.url} href={social.url} > <FontAwesomeIcon icon={social.icon} size="2x" style={{ marginRight: '20px' }} /></a>
              )
            })
            }
          </nav>
